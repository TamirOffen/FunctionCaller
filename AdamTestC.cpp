...
bool testYan4()
{
    ...
    schedule.printEventDetails("YanE", mtm::DateWrap(14, 12, 2020));
    schedule.printEventDetails("YanZ", mtm::DateWrap(1, 12, 2020));
    schedule.printEventDetails("YanR", mtm::DateWrap(25, 12, 2020));
    out.close();
