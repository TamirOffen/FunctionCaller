...
bool testArithmeticOperators() {
    ...
    DateWrap d4(30, 2, 3);
    d4 += 1;
    ASSERT(d4.dayReturn() == 1)
    d1++;
    ASSERT(d4.monthReturn() == 3)
    ASSERT(d1.yearReturn() == 2000)
    return result;
}
...
bool testDateWrapCreateDestroy_CreaterYan() {
    ...
    ASSERT(date.dayReturn() == day)
    ASSERT(date.monthReturn() == month)
    ASSERT(date.yearReturn() == year)

    ASSERT(date2.dayReturn() == day)
    ASSERT(date2.monthReturn() == month)
    ASSERT(date2.yearReturn() == year)

    date2 = date3;
    ASSERT(date2.dayReturn() == day2)
    ASSERT(date2.monthReturn() == month2)
    ASSERT(date2.yearReturn() == year2)
...
bool testDateIncrement_CreatorYan() {
    ...
    date++;
    ASSERT(date.dayReturn() == 1)
    ASSERT(date.monthReturn() == 1)
    ASSERT(date.yearReturn() == 2011)
    ...
    ASSERT(date.dayReturn() == 4)
    ASSERT(date.monthReturn() == 1)
    ASSERT(date.yearReturn() == 2011)

    DateWrap date2 = date + 10;
    ASSERT(date2.dayReturn() == 14)
    ASSERT(date2.monthReturn() == 1)
    ASSERT(date2.yearReturn() == 2011)

    date2 = 30 + date;
    ASSERT(date2.dayReturn() == 4)
    ASSERT(date2.monthReturn() == 2)
    ASSERT(date2.yearReturn() == 2011)
    return result;
}
